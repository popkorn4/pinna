...
## Текущая фаза
Фаза 7 завершена (требует ANTHROPIC_API_KEY в .env.local для работы). Следующая — фаза 8 (realtime, опциональная) или фаза 9 (деплой). Лента активности из фазы 5 ещё отложена.
